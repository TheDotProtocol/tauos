-- TauOS Mail Database Setup - FIXED VERSION
-- Run this in Supabase SQL Editor

-- Step 1: Create sent_emails table
...
-- Step 2: Create incoming_emails table
...
-- Step 3: Create indexes (after tables are created)
