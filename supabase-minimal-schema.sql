-- TauOS Minimal Database Schema
-- Run this in Supabase SQL Editor

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Organizations table (simplified)
...
-- Insert default organizations (simplified)
INSERT INTO organizations (name, domain, storage_limit) 
VALUES ('TauOS', 'tauos.org', 5368709120) -- 5GB
ON CONFLICT (domain) DO NOTHING;

INSERT INTO organizations (name, domain, storage_limit) 
VALUES ('AR Holdings Group', 'arholdings.group', 107374182400) -- 100GB
ON CONFLICT (domain) DO NOTHING;
