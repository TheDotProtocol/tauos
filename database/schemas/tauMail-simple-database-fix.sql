...
CREATE TABLE IF NOT EXISTS sent_emails (
    ...
    user_id TEXT NOT NULL,  -- Use TEXT to avoid type issues
...
-- 10. Insert some sample emails for testing (using TEXT for user_id)
...
-- 13. Show sample emails (using TEXT comparison)
...
JOIN users u ON ie.user_id = u.id::text
