-- TauOS Database Schema for TauMail and TauCloud
...
BEGIN
    ...
    -- You can add user storage tracking here if needed
    -- For now, we're just tracking at organization level
END;
$$ LANGUAGE plpgsql;
...
CREATE POLICY "Users can view emails they sent or received" ON emails
    FOR SELECT USING (sender_id = auth.uid() OR recipient_id = auth.uid());

CREATE POLICY "Users can insert emails" ON emails
