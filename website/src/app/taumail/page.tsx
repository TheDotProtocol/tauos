...
export default function TauMailLanding() {
  ...
  const handleRegistration = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://tauos-6nec-git-main-the-dot-protocol-co-ltds-projects.vercel.app/api/auth/register', {
        method: 'POST',
        headers: {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://tauos-6nec-git-main-the-dot-protocol-co-ltds-projects.vercel.app/api/auth/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
