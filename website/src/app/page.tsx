        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="https://tauos-mail-f307q44qr-the-dot-protocol-co-ltds-projects.vercel.app" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                TauMail
              </a>
              <a href="https://vercel-tauos-cloud-5z2nci0ys-the-dot-protocol-co-ltds-projects.vercel.app" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                TauCloud
              </a>
          ...
          {isMenuOpen && (
            ...
            >
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="https://tauos-mail-f307q44qr-the-dot-protocol-co-ltds-projects.vercel.app" target="_blank" rel="noopener noreferrer" className="block px-3 py-2 text-gray-300 hover:text-white transition-colors">
                  TauMail
                </a>
                <a href="https://vercel-tauos-cloud-5z2nci0ys-the-dot-protocol-co-ltds-projects.vercel.app" target="_blank" rel="noopener noreferrer" className="block px-3 py-2 text-gray-300 hover:text-white transition-colors">
                  TauCloud
                </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><a href="https://tauos-mail-f307q44qr-the-dot-protocol-co-ltds-projects.vercel.app" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">TauMail</a></li>
                <li><a href="https://vercel-tauos-cloud-5z2nci0ys-the-dot-protocol-co-ltds-projects.vercel.app" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">TauCloud</a></li>
              </ul>
            </div>
