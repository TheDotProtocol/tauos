        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Real-time status of all <span className="text-yellow-400 font-semibold">TauOS services</span> and infrastructure.
              <br />
              Monitor uptime, performance, and incident reports.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="bg-gradient-to-r from-gray-900 to-black border border-gray-800 rounded-2xl p-8 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-6">
                All TauOS services are running normally with excellent performance.
              </p>
