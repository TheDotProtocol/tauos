...
import { 
  ...
  Upload, Folder, File, HardDrive
} from 'lucide-react';
import Link from 'next/link';

export default function TauCloudAppPage() {
  ...
  const features = [
    {
      ...
      description: "Your files are encrypted before upload with military-grade security."
    },
    {
      icon: Lock,
      title: "Zero-Knowledge Storage",
      description: "We can't access your files even if we wanted to. Your privacy is absolute."
    },
    {
      icon: Eye,
      title: "No Tracking",
      description: "No file scanning, no metadata collection, no data mining."
    },
    {
      icon: Globe,
      title: "Open Standards",
      description: "Built on standard protocols. Access your files from any device."
    }
  ];
  ...
  const handleRegistration = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://tauos-47am-the-dot-protocol-co-ltds-projects.vercel.app/api/auth/register', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        alert('✅ Registration successful! Welcome to TauOS Cloud!');
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://tauos-47am-the-dot-protocol-co-ltds-projects.vercel.app/api/auth/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Private cloud storage that puts you in control. <span className="text-yellow-400 font-semibold">End-to-end encryption, zero tracking, and complete privacy by design</span>.
              <br />
              <span className="text-lg text-gray-400">Secure Storage • 100% Encrypted • Zero Data Access</span>
            </p>
          </motion.div>
          ...
          >
            <div className="text-center">
              <div className="text-3xl font-bold text-yellow-400 mb-2">1TB</div>
