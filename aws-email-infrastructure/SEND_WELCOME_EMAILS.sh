...
echo "📤 Sending Welcome Emails to Gmail..."
echo "====================================="
...
# Configure Postfix for free SMTP relay
echo "📧 Step 2: Configuring Postfix for external delivery..."

# Use a public SMTP relay that doesn't require authentication
sudo postconf -e "relayhost = [smtp-relay.gmail.com]:587"
sudo postconf -e "smtp_tls_security_level = encrypt"
sudo postconf -e "smtp_sasl_auth_enable = no"
sudo postconf -e "smtp_sasl_security_options = noanonymous"

# Alternative: Use a different public relay
