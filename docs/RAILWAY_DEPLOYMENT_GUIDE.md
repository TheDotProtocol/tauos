...
1. **Update Environment Variables in Railway Dashboard**:
   ```
   DATABASE_URL=postgresql://postgres.tviqcormikopltejomkc:Ak1233%40%405_HIDDEN@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres
   NODE_ENV=production
...
```bash
railway variables set DATABASE_URL="postgresql://postgres.tviqcormikopltejomkc:Ak1233%40%405_HIDDEN@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres"
