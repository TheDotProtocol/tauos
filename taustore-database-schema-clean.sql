-- TauStore Database Schema for Supabase - CLEAN VERSION
...
DROP TABLE IF EXISTS taustore_users CASCADE;
...
CREATE INDEX idx_taustore_users_email ON taustore_users(email);
CREATE INDEX idx_taustore_users_username ON taustore_users(username);
...
CREATE INDEX idx_apps_downloads ON apps(download_count);
...
CREATE INDEX idx_user_downloads_app ON user_downloads(app_id);
...
FROM (VALUES
    ...
    ('WhatsApp', 'whatsapp', 'Messaging and video calls', 'Connect with friends and family worldwide', 'Meta', 'social', 0.00, '/icons/whatsapp.png', 4.2, 500000000, false),
    ('Instagram', 'instagram', 'Photo and video sharing', 'Share your life through photos and videos', 'Meta', 'social', 0.00, '/icons/instagram.png', 4.1, 200000000, false),
    ('TikTok', 'tiktok', 'Short-form video content', 'Discover and create short videos', 'ByteDance', 'entertainment', 0.00, '/icons/tiktok.png', 4.0, 300000000, false),
    ('Spotify', 'spotify', 'Music streaming service', 'Listen to millions of songs and podcasts', 'Spotify', 'entertainment', 0.00, '/icons/spotify.png', 4.3, 100000000, false),
    ('Netflix', 'netflix', 'Streaming entertainment', 'Watch movies and TV shows', 'Netflix', 'entertainment', 9.99, '/icons/netflix.png', 4.4, 50000000, false),
    ('Microsoft Office', 'microsoft-office', 'Productivity suite', 'Word, Excel, PowerPoint and more', 'Microsoft', 'productivity', 6.99, '/icons/office.png', 4.5, 100000000, false),
    ('Adobe Photoshop', 'photoshop', 'Photo editing software', 'Professional image editing tools', 'Adobe', 'productivity', 20.99, '/icons/photoshop.png', 4.6, 10000000, false),
    ('Uber', 'uber', 'Ride sharing service', 'Get a ride anywhere, anytime', 'Uber', 'lifestyle', 0.00, '/icons/uber.png', 4.1, 50000000, false),
    ('Airbnb', 'airbnb', 'Travel accommodation', 'Find unique places to stay', 'Airbnb', 'lifestyle', 0.00, '/icons/airbnb.png', 4.2, 20000000, false),
    ('Bank of America', 'bank-of-america', 'Mobile banking', 'Manage your finances on the go', 'Bank of America', 'finance', 0.00, '/icons/bofa.png', 3.8, 10000000, false),
    ('PayPal', 'paypal', 'Digital wallet', 'Send and receive money securely', 'PayPal', 'finance', 0.00, '/icons/paypal.png', 4.0, 50000000, false),
    ('Duolingo', 'duolingo', 'Language learning', 'Learn languages for free', 'Duolingo', 'education', 0.00, '/icons/duolingo.png', 4.7, 20000000, false),
    ('Khan Academy', 'khan-academy', 'Free online education', 'Learn anything for free', 'Khan Academy', 'education', 0.00, '/icons/khan.png', 4.8, 10000000, false),
    ('MyFitnessPal', 'myfitnesspal', 'Fitness tracking', 'Track your health and fitness', 'Under Armour', 'health', 0.00, '/icons/myfitnesspal.png', 4.3, 10000000, false),
    ('Headspace', 'headspace', 'Meditation and mindfulness', 'Meditation made simple', 'Headspace', 'health', 12.99, '/icons/headspace.png', 4.6, 5000000, false),
    ('Minecraft', 'minecraft', 'Creative building game', 'Build, explore, and survive', 'Mojang', 'games', 6.99, '/icons/minecraft.png', 4.7, 50000000, false),
    ('Among Us', 'among-us', 'Social deduction game', 'Find the impostor among your crew', 'InnerSloth', 'games', 4.99, '/icons/amongus.png', 4.2, 20000000, false)
