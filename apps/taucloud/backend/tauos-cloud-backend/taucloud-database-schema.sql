-- TauCloud Database Schema - Ultimate File Storage System
...
-- Ensure users table has the correct data type for id (should be INTEGER based on existing schema)
-- This is just a comment - the users table should already exist with INTEGER id
...
CREATE TABLE IF NOT EXISTS file_shares (
    ...
    shared_with_user_id INTEGER REFERENCES users(id) ON DELETE CASCADE, -- NULL for public shares
...
CREATE OR REPLACE FUNCTION check_storage_quota(user_id_param INTEGER, file_size_param BIGINT)
RETURNS BOOLEAN AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION update_storage_usage(user_id_param INTEGER, file_size_change BIGINT)
RETURNS VOID AS $$
BEGIN
    UPDATE users 
...
VALUES 
    (uuid_generate_v4(), 1, '00000000-0000-0000-0000-000000000001', 'Documents', 'Important documents', '#3B82F6', 'folder'),
    (uuid_generate_v4(), 1, '00000000-0000-0000-0000-000000000001', 'Images', 'Photos and graphics', '#10B981', 'image'),
    (uuid_generate_v4(), 1, '00000000-0000-0000-0000-000000000001', 'Videos', 'Video files', '#F59E0B', 'video'),
    (uuid_generate_v4(), 1, '00000000-0000-0000-0000-000000000001', 'Music', 'Audio files', '#8B5CF6', 'music')
