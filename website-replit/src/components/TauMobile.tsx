  ...
  return (
    <section id="mobile" className="py-32 bg-[#050505] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            <span className="inline-block mb-4 px-4 py-1.5 rounded-full border border-primary/40 bg-primary/10 text-primary text-sm font-medium">
              Wave 2 — Mobile OS in development
            </span>
            ...
            <p className="text-xl text-muted-foreground mb-20 max-w-2xl mx-auto">
              ...
              <span className="block mt-3 text-base text-primary/80">
                Use Tau Mail &amp; Tau Cloud on iOS and Android via the web today — downloadable mobile OS coming in Wave 2.
              </span>
            </p>
          </motion.div>
