/* Ported from src/app/docs/page.tsx — content preserved from legacy site */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-blue-50 rounded-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="/docs/installation" className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
            ...
            <a href="/docs/quick-start" className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
              <h3 className="font-semibold text-gray-900">Quick Start</h3>
              <p className="text-sm text-gray-600">5-minute setup guide</p>
            </a>
            <a href="/docs/faq" className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
